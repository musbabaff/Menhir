 ...
 */
package com.musbabaff.menhir.gui;
...
import com.musbabaff.menhir.gui.item.render.StateRenderer;
import com.musbabaff.menhir.gui.item.render.StaticRenderer;
import com.musbabaff.menhir.gui.listener.GuiListener;
...
public class Gui<T extends GuiFiller<T>> implements InventoryHolder {
    ...
    public static final LegacyComponentSerializer COMPONENT_SERIALIZER = LegacyComponentSerializer.legacySection();
